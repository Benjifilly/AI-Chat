document.addEventListener('DOMContentLoaded', function() {    // Éléments DOM
    ...
    async function callAIAPI(message, model) {
        ...
        try {
            ...
            return formatResponse(assistantResponse, model);
    ...
    function enhanceUI() {        // Ajouter des raccourcis clavier avancés
        ...
        // Ajouter un indicateur de statut réseau
    ...
    function enhanceInputArea() {
        ...
        // Ajouter des suggestions de saisie
        addInputSuggestions();
    }
    
    // Fonction pour ajouter des suggestions de saisie
    function addInputSuggestions() {
        ...
        if (!document.querySelector('.input-suggestions')) {
            ...
            userInput.parentNode.insertBefore(suggestionsContainer, userInput.nextSibling);
            
            // Afficher les suggestions quand l'input est vide et focus
    ...
    // Fonction pour ajouter un indicateur de statut réseau
    function addNetworkStatusIndicator() {
        if (!document.querySelector('.network-status')) {
            ...
            window.addEventListener('online', function() {
                ...
                networkStatus.title = 'Connexion en ligne';
                showSuccessNotification('Connexion rétablie');
            });
            
            window.addEventListener('offline', function() {
                networkStatus.className = 'network-status offline';
                networkStatus.title = 'Connexion hors ligne';
                showWarningNotification('Connexion perdue - Mode hors ligne');
            });
            
            // État initial
            networkStatus.className = navigator.onLine ? 'network-status online' : 'network-status offline';
        }
    }
    ...
    function initializeEnhancements() {
        ...
        console.log('✅ Améliorations ChatIA initialisées');
    }
